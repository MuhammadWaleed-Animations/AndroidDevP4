...
class CatFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Initialize CatRepository
        catRepository = CatRepository(requireContext())
    ...
    private fun fetchCats() {
        ...
        catViewModel.cats.observe(viewLifecycleOwner) { cats ->
            cats?.forEach { cat ->
                Log.d(
                    "Cat Fragment",
                    "Cat: ${cat.name}, Origin: ${cat.origin}, Desc: ${cat.description}")
                    catList.add(CatModel(name = cat.name, origin = cat.origin, description = cat.description)
                )
            }
        ...
        catViewModel.error.observe(viewLifecycleOwner) { error ->
            Log.e("Cat Fragment", "Error: $error")
        }
    }
